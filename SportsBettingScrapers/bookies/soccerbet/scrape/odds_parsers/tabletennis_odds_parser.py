...
def tabletennis_odds_parser(leagues_from_sidebar, betgame_dict, betgame_outcome_dict, betgame_groups_dict):
    print("...scraping soccerbet - tabletennis")
    ...
    for league in leagues_from_sidebar:
        ...
        for match in match_info_list:
            ...
            for odds in match_odds:
                ...
                if betgame_group['Name'] != 'MEC' or betgame['Name'] != 'Konačni Ishod':
                    continue
